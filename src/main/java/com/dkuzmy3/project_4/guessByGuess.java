...
public class guessByGuess extends AppCompatActivity {
    ...
    messageHandler h1 = new messageHandler();
    messageHandler h2 = new messageHandler();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guess_by_guess);
    ...
    class threadOne extends Thread {           // thread one
        ...
        public void run() {
            ...
            while(!finished){                           // LOOPER! manual looper still a looper
                //Looper.prepare();
                //Looper.loop();
    ...
    class threadTwo extends Thread {           // thread two
        ...
        public void run() {
            ...
            while(!finished){                               // LOOPER!
                ...
                //twoDtoOneD();
                if(finished)makeGuess(a);
                if(finished)h2.sendEmptyMessage(1);
                onPause();
            }
        }
